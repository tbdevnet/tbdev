...
if ($ip)
{
	...
	else
	{
	  ...
	  $banstable .= "</table>\n";
	  stderr("Result", "<table border='0' cellspacing='0' cellpadding='0'><tr><td class='embedded' style='padding-right: 5px'><img src=\"{$TBDEV['pic_base_url']}smilies/excl.gif\" alt='' /></td><td class='embedded'>The IP address <b>$ip</b> is banned:</td></tr></table><p>$banstable</p>");
	}
}
stdhead();
